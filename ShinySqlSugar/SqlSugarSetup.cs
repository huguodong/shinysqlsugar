...
namespace ShinySqlSugar
{
    ...
    public static class SqlSugarSetUp
    {
        ...
        public static IServiceCollection AddSqlSugar(this IServiceCollection services, List<ConnectionConfig> connectionConfigs, bool outputSql = true, List<TableFilters> filters = null)
        {
